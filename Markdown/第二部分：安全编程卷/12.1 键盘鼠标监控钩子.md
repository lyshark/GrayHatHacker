...
description: >-
  本节将介绍如何使用`Windows
  API`中的`SetWindowsHookEx`和`RegisterHotKey`函数来实现键盘鼠标的监控。这些函数可以用来设置全局钩子，通过对特定热键挂钩实现监控的效果，两者的区别在于`SetWindowsHookEx`函数可以对所有线程进行监控，包括其他进程中的线程，而`RegisterHotKey`函数只能对当前线程进行监控。
tags:
  - 《灰帽黑客：攻守道》
  - 第二部分：安全编程卷
categories: 《灰帽黑客：攻守道》
...
![](/image/1379525-20230510101936438-1771246080.png)
...
![](/image/1379525-20230510103424436-1424837633.png)
...
![](/image/1379525-20230510122545503-185652063.png)