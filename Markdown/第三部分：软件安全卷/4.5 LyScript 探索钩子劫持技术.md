...
![](/image/1379525-20230406100112509-575027280.png)

当执行`set_debug("Run")`则会执行如下图所示代码，这些代码则是经过填充的，由于此处仅仅只是一个演示案例，所以不具备任何实战性，读者在该案例中学会指令的替换是如何实现的即可；

![](/image/1379525-20230406100251547-841685280.png)
...
![](/image/1379525-20230406104657640-1284262907.png)
...
![](/image/1379525-20230406110118621-440325587.png)
