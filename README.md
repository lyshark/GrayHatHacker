...
本书创作全程不以盈利为目的，亦无商业出版计划，现已完成版权登记并正式公开发布。本书全部内容源自作者 2018 至 2023 年长期博客记录下的各类知识积累，内容以安全编程为核心方向。作者把平日学习产生的思考、亲手编写的各类代码片段加以系统性梳理、分类与整合，融汇汇总后编撰成这本实用性极强的专业图书，对于喜爱相关技术的爱好者而言，该书能够提供一套完整清晰的学习参考体系；

依托该书开展学习，能够快速踏入二进制安全相关领域，倘若能够充分钻研、吃透书中全部技术原理与实操细节，便可具备成长为一名专业优秀白帽子安全从业者的完整能力。谨以此书抛砖引玉，推动知识走向大众化普及。
